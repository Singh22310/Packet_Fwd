...
2. Relays those files to all connected Raspberry Pis
...
CONFIG = {
    ...
    "log_dir": "/home/root/outgoing",           # Directory to store logs
    "raspberry_pis": [
        {"name": "raspberry", "ip": "192.168.1.118", "user": "raspberry", "password": "raspberry", "target_dir": "/home/raspberry/received_files"},
        {"name": "raspberry", "ip": "192.168.1.245", "user": "raspberry", "password": "raspberry", "target_dir": "/home/raspberry/received_files"},
        {"name": "dev1", "ip": "192.168.1.118", "user": "dev1", "password": "rasp@pi", "target_dir": "/home/dev1/received_files"}
    ],
...
# Relay file to all Raspberry Pis
def relay_file_to_raspberry_pis(file_path):
    file_name = os.path.basename(file_path)
    file_size = os.path.getsize(file_path)
    
    logger.info(f"Relaying file: {file_name} ({file_size} bytes) to all Raspberry Pis")
    ...
    # Send to each Raspberry Pi
    for pi in CONFIG["raspberry_pis"]:
        try:
